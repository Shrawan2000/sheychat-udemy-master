...
function Profile() {
  ...
  return (
    user && (
      ...
      <div className="text-lg sm:text-xl font-semibold uppercase text-gray-500 flex gap-2 flex-col p-4 shadow-md border w-full sm:w-max border-gray-300 rounded">
        <h1>{user.name}</h1>
        <h1>{user.email}</h1>
        <h1>
          Created At:{" "}
